...
window.onscroll = function() {
    ...
    if (window.pageYOffset > headerSection.offsetHeight - 75) {
        ...
        logoImage.src = "./Logotipo_RINGARDE-bk-bg-preview.png";
    } else {
        nav.classList.remove("active");
        logoImage.src = "./Logotipo_RINGARDE_bg.png";
    }
    ...
    // home page JS
    if (pageTitle.text === "RINGARDE - Restaurant") {
...
// home page JS
if (pageTitle.text === "RINGADE - Restaurant") {
